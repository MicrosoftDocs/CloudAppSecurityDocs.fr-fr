...
| TotalEvents | Entier | Total number of events per session | 122 |
| BlockedEvents | Entier | Number of blocked events | 0 |
| UploadedBytes | Entier | Amount of uploaded data | 1,514,874 |
| TotalBytes | Entier | Total amount of data | 4,067,785 |
| DownloadedBytes | Entier | Amount of downloaded data | 2,552,911 |
...
| AppId | Entier | Cloud app identifier | 15600 |
| AppCategory | String | Category of cloud app | Cloud storage |
| AppTags | Table de chaînes | Built-in and custom tags defined for the app | ["sanctioned"] |
| AppScore | Entier | The risk score of the app in a scale 0-10, 10 being  a score for a non-risky app | 10 |
