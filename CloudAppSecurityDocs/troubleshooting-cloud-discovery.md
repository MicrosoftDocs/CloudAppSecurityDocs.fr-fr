...
|État du collecteur de journaux : Déconnecté|Aucune donnée n’a été reçue au cours des dernières 24 heures à partir des sources de données liées.|Vérifiez que le paramètre d’exportation des journaux sur votre appliance est défini correctement.|
