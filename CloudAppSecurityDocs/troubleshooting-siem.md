...
4. Activez le **mode de récupération** en activant la case à cocher mode de récupération. Cette action configure automatiquement l’agent SIEM pour envoyer uniquement les activités manquantes en raison du problème et arrêter l’envoi d’activités une fois que toutes les activités ont été entièrement récupérées.
5. Enregistrez les paramètres.
6. Exécutez le nouvel agent à l’aide du jeton généré.
