---
title: Protéger avec Microsoft Cloud App Security contrôle d’application par accès conditionnel
description: Cet article fournit des informations sur le fonctionnement du Cloud App Security contrôle d’application par accès conditionnel proxy inverse.
keywords: ''
author: shsagir
ms.author: shsagir
manager: shsagir
...
Contrôle d’application par accès conditionnel permet de surveiller et de contrôler en temps réel les sessions et les accès aux applications utilisateur en fonction des stratégies d’accès et de session. Les stratégies d’accès et de session sont utilisées dans le portail Cloud App Security pour affiner davantage les filtres et définir des actions à effectuer sur un utilisateur. Avec les stratégies d’accès et de session, vous pouvez :
...
Contrôle d’application par accès conditionnel vous permet de créer des stratégies qui tiennent compte du fait qu’un appareil est géré ou non. Pour identifier l’état d’un appareil, vous pouvez configurer des stratégies d’accès et de session pour vérifier les éléments suivants :

- Appareils conformes à Microsoft Intune (Intune)
- Azure AD Hybride des appareils joints
...
- Portail Azure (version préliminaire)
- Box
- Concur
- Pierres angulaires à la demande
- DocuSign
- Dropbox
...
- Mou
- Liq
- Microsoft Teams (version préliminaire)
- Workday
- Workiva
- Workplace par Facebook
- Yammer (version préliminaire)
