...
**Étape 5 : [Activer l’application pour l’utiliser dans votre organisation](#enable-app)**
...
1. Dans la barre de menus, cliquez sur l’icône Paramètres roue dentée icône paramètres ![icône](./media/settings-icon.png "paramètres"), puis sélectionnez **contrôle d’application par accès conditionnel**.
...
## Étape 5 : Activer l’application pour l’utiliser dans votre organisation<a name="enable-app"></a>
...
1. Dans Cloud App Security, cliquez sur l’icône Paramètres roue dentée icône paramètres ![icône](./media/settings-icon.png "paramètres"), puis sélectionnez **contrôle d’application par accès conditionnel**.
