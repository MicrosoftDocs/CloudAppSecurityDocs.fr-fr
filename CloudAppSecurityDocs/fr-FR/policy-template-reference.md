...
Voici la liste de tous les modèles de stratégie qui existent dans Microsoft Cloud App Security. Il est recommandé de commencer avec une stratégie créée à partir d’un modèle existant pour une utilisation plus facile.
