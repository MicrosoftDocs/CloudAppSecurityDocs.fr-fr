---
title: Configuration réseau requise-Cloud App Security | Microsoft Docs
description: Cet article décrit les adresses IP et les ports que vous devez ouvrir pour travailler avec Cloud App Security.
keywords: ''
author: shsagir
ms.author: shsagir
manager: shsagir
...
Certaines des exigences ci-dessous dépendent du centre de données auquel vous êtes connecté.

Pour voir le centre de données auquel vous vous connectez, procédez comme suit :

1. Dans le portail Cloud App Security, cliquez sur l' **icône point d’interrogation** dans la barre de menus. Ensuite, sélectionnez **à propos de**.

    ![Cliquez sur à propos de](media/about-menu.png)

2. Dans l’écran Cloud App Security version, vous pouvez voir la région et le centre de données.
...
En outre, les éléments suivants doivent être inclus dans la liste verte, en fonction du centre de données que vous utilisez :
...
> |Unis 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|\*. us2.portal.cloudappsecurity.com|
...
> |EU1|13.80.125.22<br />40.119.154.72<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.157.238.58<br />52.174.56.180<br />52.183.75.62|\*. UE. Portal. cloudappsecurity. com <|
...
> [!NOTE]
> Au lieu d’un caractère générique (\*), vous pouvez ouvrir uniquement votre URL de locataire spécifique, par exemple, en fonction de la capture d’écran ci-dessus, vous pouvez ouvrir : mod244533.us.portal.cloudappsecurity.com
...
> |Unis 2|13.80.125.22<br />20.36.222.59<br />20.36.222.60<br />40.74.1.235<br />40.74.6.204<br />51.143.58.207<br />52.137.89.147<br />52.183.75.62<br />52.184.165.82|
...
> [!NOTE]
> Si vous n’avez pas spécifié de proxy lors de la configuration de l’agent SIEM Cloud App Security, vous devez autoriser les connexions http à http://ocsp.msocsp.com/ et ocsp.digicert.com sur le port 80. Cette valeur est utilisée pour vérifier l’état de révocation du certificat quand vous vous connectez au portail Cloud App Security.

## <a name="app-connector"></a>Connecteur d’applications

Pour que certaines applications tierces soient accessibles par Cloud App Security, ces adresses IP peuvent être utilisées. Les adresses IP permettent à Cloud App Security de collecter des journaux et de fournir un accès pour la console Cloud App Security.

> [!NOTE]
>Vous pouvez voir ces adresses IP dans les journaux d’activité du fournisseur, car Cloud App Security effectue des actions de gouvernance et des analyses à partir de ces adresses IP.

Pour vous connecter à des applications tierces, activez Cloud App Security pour vous connecter à partir de ces adresses IP :
...
> |Unis 2|13.68.76.47<br />20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.42.54.148<br />104.46.122.189<br />|
...
## <a name="third-party-dlp-integration"></a>Intégration de DLP tierce

Pour permettre à Cloud App Security d’envoyer des données via votre stunnel à votre serveur ICAP, ouvrez votre pare-feu DMZ sur ces adresses IP avec un numéro de port source dynamique.

1. **Adresses sources** : ces adresses doivent figurer dans la liste verte comme indiqué ci-dessus pour les applications tierces du connecteur d’API
...
4. **Port TCP de destination** , tel que défini dans votre réseau

> [!NOTE]
>
> - Par défaut, le numéro de port du stunnel a la valeur 11344. Vous pouvez le remplacer par un autre port si nécessaire, mais veillez à noter le nouveau numéro de port.
> - Vous pouvez voir ces adresses IP dans les journaux d’activité du fournisseur, car Cloud App Security effectue des actions de gouvernance et des analyses à partir de ces adresses IP.

Pour vous connecter à des applications tierces et les intégrer à des solutions DLP externes, activez Cloud App Security pour vous connecter à partir de ces adresses IP :
...
> |Unis 2|20.36.222.59<br />20.36.222.60<br />40.67.152.91<br />40.67.154.160<br />40.67.155.146<br />40.67.159.55<br />40.84.2.83<br />40.84.4.119<br />40.84.4.93|52.184.165.82<br />52.232.224.227<br />52.232.225.84<br />104.46.116.211<br />104.46.116.211<br />104.46.121.72<br />104.46.121.72<br />104.46.122.189<br />104.46.122.189|
...
Pour permettre l’envoi de notifications à partir du modèle et des paramètres par défaut, ajoutez ces adresses IP à votre liste d’autorisation anti-spam. Les adresses IP de messagerie dédiées Cloud App Security sont les suivantes :
...
Si vous souhaitez personnaliser l’identité de l’expéditeur du courrier électronique, Microsoft Cloud App Security permet la personnalisation à l’aide de MailChimp®, un service de messagerie tiers. Pour le faire fonctionner, dans le portail Microsoft Cloud App Security, accédez à **paramètres**. Sélectionnez **paramètres de messagerie** et passez en revue les conditions d’entretien et la déclaration de confidentialité de MailChimp. Ensuite, accordez à Microsoft l’autorisation d’utiliser MailChimp en votre nom.
...
Pour activer les fonctionnalités de Cloud Discovery à l’aide d’un collecteur de journaux et détecter l’occultation dans votre organisation, ouvrez les éléments suivants :
...
- Autoriser le collecteur de journaux à initier le trafic sortant vers le stockage d’objets BLOB Azure sur le port 443 :

  | Centre de données |                        URL                                 |
  |-------------|------------------------------------------------------------|
  |     US1     | https :\//adaprodconsole.blob.core.windows.net/             |
  |     Unis 2     | https :\//prod03use2console1.blob.core.windows.net/         |
...
>- Autorisez le collecteur de journaux à initier le trafic sortant vers le portail Cloud App Security.
