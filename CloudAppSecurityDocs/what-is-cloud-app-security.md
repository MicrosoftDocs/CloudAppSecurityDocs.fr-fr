...
## <a name="what-is-a-casb"></a>Qu'est-ce qu’un CASB ?
...
## <a name="why-do-i-need-a-casb"></a>Pourquoi un CASB est-il nécessaire ?

Vous avez besoin d'un CASB pour mieux comprendre votre position globale sur le cloud à travers les applications SaaS et les services cloud et, à ce titre, la découverte de l’informatique fantôme et la gouvernance des applications constituent des cas d'utilisation clés. Par ailleurs, une organisation est responsable de la gestion et de la sécurisation de sa plate-forme de cloud computing, y compris l'IAM, les machines virtuelles et leurs ressources informatiques, les données et le stockage, les ressources réseau, etc. Par conséquent, si votre organisation utilise, ou envisage d'utiliser, des applications cloud pour votre portefeuille de services réseau, vous avez très probablement besoin d'un CASB pour relever les défis supplémentaires et uniques que représentent la réglementation et la sécurisation de votre environnement. Il existe par exemple de nombreuses façons pour les acteurs malveillants d'exploiter les applications cloud afin de pénétrer dans votre réseau d'entreprise et d’exfiltrer des données commerciales sensibles.
